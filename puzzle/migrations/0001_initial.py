    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, related_name='puzzle_like', to=settings.AUTH_USER_MODEL)),
                ('to_do', models.ManyToManyField(blank=True, related_name='to_do', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-created',),
            },
